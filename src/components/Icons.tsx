...
export const IconFlame = wrap('M12 2c1 3 0 5-2 6-1 1-2 2-2 4a4 4 0 0 0 8 0c0-2-1-3-1-5 1 1 2 3 2 5a6 6 0 0 1-12 0c0-4 4-6 7-10z')
export const IconGrid = wrap('M4 4h7v7H4zM13 4h7v7h-7zM4 13h7v7H4zM13 13h7v7h-7z')
export const IconTrash = wrap('M6 7h12M9 7V5a1 1 0 0 1 1-1h4a1 1 0 0 1 1 1v2M8 7l1 12a1 1 0 0 0 1 1h4a1 1 0 0 0 1-1l1-12M10 11v6M14 11v6')
export const IconBar = wrap('M5 21V10M12 21V4M19 21v-7M3 21h18')
